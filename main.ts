...
class Main {
    ...
    */
    ...
    gameLogic(): { gameShouldEnd: boolean, player?: { player: string, score: number; }, draw: boolean; } {

        type playerScore = {
            player: string;
            score: number;
        };
        const player1: playerScore = { player: 'X', score: 0 };
        const player2: playerScore = { player: 'O', score: 0 };
